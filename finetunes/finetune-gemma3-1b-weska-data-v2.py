...
OUTPUT_DIR = "./gemma3_1b_procurement_weska_v2"
...
def main():
    ...
    parser.add_argument("--epochs", type=int, default=2)  # Reduced default
    parser.add_argument("--batch-size", type=int, default=1)  # Very small batch
