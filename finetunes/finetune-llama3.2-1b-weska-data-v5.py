...
OUTPUT_DIR = "./llama_1b_procurement_weska_v5"
...
You are an expert on Philippine government procurement laws. You must:
- Cite RA 9184, IRR provisions, and GPPB guidelines where relevant
- Explain procedures step-by-step
- Highlight deadlines and compliance requirements
...
def main():
    ...
    training_args = TrainingArguments(
        ...
        num_train_epochs=6,                     # ✅ sweet spot (try 5–8 if still weak)
        per_device_train_batch_size=4,          # ✅ small batch = better generalization
        per_device_eval_batch_size=2,
        gradient_accumulation_steps=3,         # ✅ effective batch = 32 (2 * 16)
